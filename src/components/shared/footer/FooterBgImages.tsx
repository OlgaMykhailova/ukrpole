  ...
  return (
    <>
      <Image
        ...
        width="360"
        height="73"
        className="absolute -top-[calc(0.203*100vw-2px)] tab:hidden w-full h-auto"
      />
      <Image
        ...
        width="768"
        height="98"
        className="absolute -top-[calc(0.128*100vw-2px)] hidden tab:block laptop:hidden w-full h-auto"
      />
      <Image
