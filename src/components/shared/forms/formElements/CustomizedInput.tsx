...
const fieldWrapperStyles =
  "relative group before:content-[''] before:absolute before:top-[-2px] before:left-[-2px] before:rounded-[8px] before:w-[calc(100%+5px)] before:h-[calc(100%+5px)] before:blur-[2px] before:transition before:duration-300 before:ease-out ";
      ...
      <div
        className={`${fieldWrapperStyles} ${wrapperClassName} ${
          errors[fieldName] && touched[fieldName]
            ? "before:bg-red"
            : "before:bg-transparent focus-within:before:bg-greenLight"
        }`}
      >
        {image && (
          <Image
            ...
            width={67}
            height={22}
            className="absolute bottom-1/2 left-[10px] z-10 transform translate-y-1/2"
          />
        )}
        <Field
          as={as}
