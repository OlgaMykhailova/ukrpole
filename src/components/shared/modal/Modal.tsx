...
export default function Modal({
  ...
  return (
    <div
      ...
      } fixed left-1/2 bottom-0 transform -translate-x-1/2 -translate-y-[calc(50dvh-50%)] transition duration-[600ms] ease-out z-50 min-w-[312px] max-w-[368px] tab:max-w-[496px] 
